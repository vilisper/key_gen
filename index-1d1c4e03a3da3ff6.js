...
function __wbg_adapter_24(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__Fn__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hcb290d269e122462(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {string}
*/
export function generate_license(text) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.generate_license(retptr, ptr0, len0);
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('index-1d1c4e03a3da3ff6_bg.wasm', import.meta.url);
    }
    const imports = {};
    imports.wbg = {};
